...
const Register = () => {
    ...
    const {handleCreateUser, setUser, handleUpdatedUserProfile, handleGoogleSingIn} = use(AuthContext);
    ...
    return (
        ...
        <HelmetProvider>
            ...
            <form onSubmit={handleRegister} className="card-body">
                ...
                <p className='font-medium text-sm mt-5 text-center'>Already have account? <Link className='text-primary font-bold' to="/login">Login</Link></p>
