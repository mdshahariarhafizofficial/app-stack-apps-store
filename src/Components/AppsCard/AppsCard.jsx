      ...
      <div className="relative overflow-hidden card bg-base-100 shadow-sm border-1 border-gray-200">
        ...
        <div className="card-body items-center text-center">
          ...
          <div className="space-y-4">
            <p className="flex gap-2 justify-center text-base font-semibold items-center text-[#fa8b16]">
              {<FaStar size={20} color="#fa8b16"></FaStar>} {rating}
            </p>

            <p className="flex gap-2 justify-center text-base font-semibold items-center text-accent">
              {" "}
        ...
        {isTrending ? (
          <p className="absolute top-4 -left-10 bg-red-600 text-white font-bold w-40 text-sm text-center py-1 rotate-[-35deg]">
            Trending
          </p>
        ) : (
          ""
